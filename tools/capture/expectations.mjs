...
export const EXPECTATIONS = [
  ...
  },
  {
    ...
    mustShow: [
      ...
      "THE OTHER TWO PANES STILL DECLINE, IN THEIR OWN WORDS. The Call Trace: frames are recorded and carry no function names or source positions. The Values pane: naming a local needs the debug symbols from the contract's compiled artifact, and none resolved. Neither may sit blank.",
