...
##    relative stroke (3px on 24px) and the six level-two headings the heaviest
##    (3-4px on 17px), so size and weight still pull in opposite directions.
...
##    ledger@2026-09-01.6:tx-detail/wide/light/L1/7, which finds the cost row's
...
##    ledger@2026-09-01.6:tx-detail/wide/light/L1/3 has 22 characters of
